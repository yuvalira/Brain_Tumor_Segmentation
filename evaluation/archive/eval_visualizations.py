...
def plot_metrics_histogram(
    ...
    # Save figure to output/diagnostic_figures relative to PROJECT_ROOT
    output_dir = Path(PROJECT_ROOT) / "output" / "diagnostic_figures"
    output_dir.mkdir(parents=True, exist_ok=True)

    output_png = output_dir / f"{file_path.stem}_{metric_key}_hist.png"
